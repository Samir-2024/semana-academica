...
| `ui/` | Interface web (Vanilla HTML/CSS/JS) |
...
Para regras específicas da interface (stack, comandos, estrutura, testes), consulte:
...
## 8. Comandos (executados dentro de `api/`)
...
## 9. Comandos (executados dentro de `ui/`)
...
## 11. Conflito entre implementação e decisão funcional
...
- **API:** Node.js 22+, TypeScript, Fastify, SQLite (sql.js), Zod, node:test
- **UI:** Vanilla HTML/CSS/JS (sem build), Node.js test runner + jsdom